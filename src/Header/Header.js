...
const Header = () => {
    ...
    return (
        <div className='px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-24  bg-green-300 '>
            <div className='relative flex items-center text-white justify-between'>
                <Link
                    to='/'
                    aria-label='online learnig'
                    title='online learnig'
                ...
                <ul className='flex items-center hidden space-x-8 lg:flex'>
                    <li>
                        <Link
                            ...
                            aria-label='Home'
                            title='Home'
                            className='text-2xl text-bold font-medium tracking-wide text-white transition-colors duration-200 hover:text-deep-purple-accent-400'
                        >
                            Home
                        </Link>
                    </li>
                    <li>
                        <Link
                            ...
                            aria-label='Quiz'
                            title='Quiz'
                            className='font-medium tracking-wide text-white transition-colors duration-200 hover:text-deep-purple-accent-400 text-2xl text-bold '
                        >
                            Quiz
                        </Link>
                    </li>
